...
namespace TaskDelegatingWebApp.Controllers
{
    public class TaskAssignmentsController : Controller
    {
        ...
        {
            var taskDelegatingWebAppContext = _context.TaskAssignments.Include(t => t.Person).Include(t => t.TaskItem);
        ...
        public async Task<IActionResult> Create([Bind("PersonId,TaskItemId")] TaskAssignment taskAssignment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonId,TaskItemId")] TaskAssignment taskAssignment)
        {
