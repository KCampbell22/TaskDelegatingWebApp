...
namespace TaskDelegatingWebApp.Controllers
{
    public class TaskItemsController : Controller
    {
        ...
        {
            var taskDelegatingWebAppContext = _context.TaskItem.Include(t => t.AssignedDay).Include(t => t.AssignedPerson);
        ...
        public async Task<IActionResult> Create([Bind("TaskItemId,TaskName,PersonId,DayId")] TaskItem taskItem)
        {
            ...
            ViewData["PersonId"] = new SelectList(_context.Person, "PersonId", "PersonId", taskItem.PersonId);
            return View(taskItem);
        }
        ...
        {
            var week = _context.Week.OrderBy(e => e.Id).Last();

            return RedirectToAction("Details", "Weeks", week.Id);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TaskItemId,TaskName,PersonId,DayId")] TaskItem taskItem)
        {
